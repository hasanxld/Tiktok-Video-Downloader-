  ...
  const features = [
    {
      ...
      description:
        "Download TikTok videos in their original quality with multiple format options including HD and Full HD.",
    },
    {
      icon: Zap,
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="font-body text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
              We're passionate about creating the best TikTok video downloading experience for users worldwide
            </p>
          </div>
          ...
          <section className="bg-card p-8 border border-border text-center space-y-6">
            ...
            <p className="text-muted-foreground text-pretty max-w-3xl mx-auto text-lg leading-relaxed">
              We believe that everyone should have easy access to download and save their favorite TikTok content. Our
              platform provides a simple, fast, and secure way to download TikTok videos without any hassle. We're
