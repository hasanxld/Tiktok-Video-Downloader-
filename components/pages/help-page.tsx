  ...
  const faqs = [
    {
      ...
      answer:
        "Simply paste the TikTok video URL into the input field on the home page and click the Download button. Our system will process the video and provide download options.",
    },
    {
    ...
    },
    {
      ...
      answer: "Yes! Our TikTok video downloader is completely free to use. No registration or subscription required.",
    },
    {
      question: "Can I download private videos?",
      answer: "No, you can only download public TikTok videos. Private videos are not accessible through our service.",
    },
    {
      question: "Why is my download failing?",
      answer:
        "Downloads may fail due to invalid URLs, private videos, or temporary server issues. Make sure you're using a valid public TikTok video URL.",
    },
  ]
  ...
  const steps = [
    {
      ...
      description: "Go to TikTok, find the video you want to download, and copy its URL from the share menu.",
    },
    {
      icon: Download,
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="font-body text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
              Everything you need to know about using our TikTok video downloader
            </p>
          </div>
