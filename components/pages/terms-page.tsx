        ...
        <div className="space-y-8">
          <div className="bg-card border border-border p-6 hover-lift">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>You may use our TikTok video downloader service for:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>Downloading TikTok videos for personal use</li>
                <li>Educational and research purposes</li>
                <li>Content creation with proper attribution</li>
                <li>Backup of your own TikTok content</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-card border border-border p-6 hover-lift">
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>Any illegal activities or violations of TikTok's terms</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-card border border-border p-6 hover-lift">
            ...
            <div className="space-y-4 text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>We are not affiliated with TikTok or ByteDance</li>
